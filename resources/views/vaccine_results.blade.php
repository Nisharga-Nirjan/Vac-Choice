...
<head>
    ...
    <title>Search Results for Vaccine</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset" style="margin-top:20px;">
                <h4>Vaccine Results</h4>
                <hr>
                <form action="search-vaccine" method="post">
                    @csrf
                    <input type="text" name="query" placeholder="Find Your Vaccine!">
                    <button type="submit">Search</button>
                </form>
                <ul>
                    @foreach ($results as $result)
                        <li>{{ $result }}</li>
                        <form action="selected-vaccine" method="post" style="display: inline;">
                            @csrf
